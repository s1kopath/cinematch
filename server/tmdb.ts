...
async function makeRequest<T>(endpoint: string, params: Record<string, string | number> = {}): Promise<T> {
  if (!ENV.tmdbApiKey) {
...
export async function fetchUpcomingMovies(page: number = 1): Promise<TMDBResponse> {
